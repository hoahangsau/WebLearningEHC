...
Ở level này thì chúng ta thấy dòng  
<pre>
   $extension = explode(".", $filename)[1];
</pre>
chia filename ra thành các mảng phần tử rồi lấy phần tử thứ 2(chính là phần tử extension).
Cách bypass đó là đổi tên file theo dạng file.png.php rồi upload. 
